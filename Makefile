...
CFLAGS_KERNEL	= $(GRAPHITE) -mcpu=cortex-a57.cortex-a53+crc+crypto -mtune=cortex-a57.cortex-a53+crc+crypto
...
KBUILD_CFLAGS   := $(GRAPHITE) -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common \
		   ...
		   -mcpu=cortex-a57.cortex-a53+crc+crypto -mtune=cortex-a57.cortex-a53+crc+crypto -std=gnu89 \
